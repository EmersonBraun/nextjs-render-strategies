...
export default async function SSGPage({ params }: { params: Promise<{ id: string; locale: string }> }) {
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground">
          {t('step1.currentPageId')} <span className="font-mono bg-muted px-2 py-1 rounded">{id}</span>
        </p>
      </div>
