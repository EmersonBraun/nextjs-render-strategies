              ...
              <div className="space-y-6 relative">
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("serverFetchesData")}</span>
                  </div>
                  {currentStep >= 2 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <div className="font-semibold text-lg font-mono">React.renderToReadableStream()</div>
                    <div className="text-sm text-muted-foreground mt-2">{t("serverRendersRSC")}</div>
                  </div>
                  {currentStep >= 3 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("serverSerializesRSC")}</span>
                  </div>
                  {currentStep >= 4 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-lg">{t("serverSendsRSCPayload")}</span>
                      {currentStep >= 4 && (
              ...
              <div className="space-y-6 relative">
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-blue-500 rounded-xl p-6 bg-blue-50/50 dark:bg-blue-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("clientReceivesRSCPayload")}</span>
                  </div>
                  {currentStep >= 6 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-blue-500 rounded-xl p-6 bg-blue-50/50 dark:bg-blue-950/30 shadow-md">
                    ...
                    <div className="text-sm text-muted-foreground mt-2">{t("clientHydratesComponents")}</div>
                  </div>
                  {currentStep >= 7 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
