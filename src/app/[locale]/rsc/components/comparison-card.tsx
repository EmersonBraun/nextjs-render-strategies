...
export function ComparisonCard() {
  const t = useTranslations('pages.rsc.comparison')
        ...
        <div className="p-4 bg-orange-50 dark:bg-orange-950 border border-orange-200 dark:border-orange-800 rounded-lg">
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-green-600 dark:text-green-400 font-semibold">Optimal</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="font-medium">{t('seoPerformance')}:</span>
              <span className="text-green-600 dark:text-green-400 font-semibold">Great</span>
            </div>
            <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-yellow-600 dark:text-yellow-400 font-semibold">Balanced</span>
            </div>
            <div className="mt-3">
