          ...
          <div className="p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              <div className="flex justify-between">
                <span className="text-green-700 dark:text-green-300">{t('serverTimestamp')}</span>
                <span className="text-green-800 dark:text-green-200">{serverData.timestamp}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-green-700 dark:text-green-300">{t('environment')}</span>
                <span className="text-green-800 dark:text-green-200">{serverData.environment}</span>
              </div>
            </div>
