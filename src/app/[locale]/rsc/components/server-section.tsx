        ...
        <div className="p-6 bg-gray-50 dark:bg-gray-950/30 border-2 border-dashed border-gray-500 rounded-xl">
          ...
          <div className="space-y-4 relative">
            ...
            >
              ...
              <div className="border-2 border-solid border-gray-500 rounded-xl p-4 bg-gray-50/50 dark:bg-gray-950/30 shadow-md min-h-[70px] flex flex-col justify-center">
