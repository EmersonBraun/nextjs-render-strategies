            ...
            <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-950/30 border-2 border-dashed border-gray-500 rounded-xl">
              ...
              <div className="flex justify-center items-center gap-6 mb-6 relative">
                <div className={`w-20 h-20 bg-blue-500 rounded-xl flex items-center justify-center text-white text-4xl shadow-lg transition-all duration-500 ${
                  currentStep >= 0 ? "opacity-100 scale-100" : "opacity-30 scale-90"
                }`}>
                  🌐
                </div>
                <div className="flex flex-col gap-3 relative">
                  ...
                  <div className="text-xs text-center text-muted-foreground font-medium">Streaming</div>
                </div>
              ...
              <div className="space-y-6 relative">
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("serverReceivesRequest")}</span>
                  </div>
                  {currentStep >= 1 && (
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("serverStartsRendering")}</span>
                  </div>
                  {currentStep >= 2 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("serverRendersFastContent")}</span>
                  </div>
                  {currentStep >= 3 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-lg">{t("serverStreamsChunk1")}</span>
                      {currentStep >= 3 && (
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <div className="font-semibold text-lg font-mono">&lt;Suspense&gt;</div>
                    <div className="text-sm text-muted-foreground mt-2">{t("serverRendersSlowContent")}</div>
                  </div>
                  {currentStep >= 6 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-gray-500 rounded-xl p-6 bg-gray-50/50 dark:bg-gray-950/30 shadow-md">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-lg">{t("serverStreamsChunk2")}</span>
                      {currentStep >= 6 && (
                        <span className="text-gray-600 dark:text-gray-400 text-2xl animate-pulse">✓</span>
                      )}
                    </div>
              ...
              <div className="space-y-6 relative">
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-blue-500 rounded-xl p-6 bg-blue-50/50 dark:bg-blue-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("clientReceivesChunk1")}</span>
                  </div>
                  {currentStep >= 7 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-dashed border-blue-500 rounded-xl p-6 bg-blue-50/50 dark:bg-blue-950/30 shadow-md">
                    <span className="font-semibold text-lg">{t("clientReceivesChunk2")}</span>
                  </div>
                  {currentStep >= 8 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
                ...
                <div className={`relative transition-all duration-500 ${
                  ...
                  <div className="border-2 border-solid border-blue-500 rounded-xl p-6 bg-blue-50/50 dark:bg-blue-950/30 shadow-md">
                    <div className="font-semibold text-lg font-mono">React.hydrateRoot()</div>
                  </div>
                  {currentStep >= 9 && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-8 bg-gray-400"></div>
                  )}
