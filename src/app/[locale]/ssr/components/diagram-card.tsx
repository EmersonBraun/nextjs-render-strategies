...
export function DiagramCard() {
  const t = useTranslations("pages.ssr.diagram");
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-h-[calc(100vh-200px)] overflow-y-auto">
        {/* Server Section */}
        <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-950/30 border-2 border-dashed border-gray-500 rounded-xl">
          <h4 className="text-lg font-bold text-center text-gray-700 dark:text-gray-400 mb-3">
            {t("server")}
          </h4>
          ...
          <div className="flex justify-center items-center gap-4 mb-4 relative">
            <div
              className={`w-16 h-16 bg-blue-500 rounded-xl flex items-center justify-center text-white text-3xl shadow-lg transition-all duration-500 ${
                currentStep >= 0
          ...
          <div className="space-y-3 relative">
            ...
            >
              <div className="border-2 border-dashed border-gray-500 rounded-xl p-3 bg-gray-50/50 dark:bg-gray-950/30 shadow-md min-h-[60px] flex items-center">
            ...
            >
              ...
              <div className="border-2 border-solid border-gray-500 rounded-xl p-3 bg-gray-50/50 dark:bg-gray-950/30 shadow-md min-h-[60px] flex items-center">
                <span className="font-semibold text-base text-gray-900 dark:text-gray-100">
                  {t("serverFetchesData")}
                </span>
              </div>
            ...
            {/* Step 3: Server renders HTML (React.renderToString) */}
            <div
              className={`relative transition-all duration-500 ${
            ...
            >
              ...
              <div className="border-2 border-dashed border-gray-500 rounded-xl p-3 bg-gray-50/50 dark:bg-gray-950/30 shadow-md min-h-[60px] flex items-center justify-between">
                <span className="font-semibold text-base text-gray-900 dark:text-gray-100">
                  {t("serverSendsHTML")}
                </span>
                {currentStep >= 3 && (
        ...
        <div className="p-3 bg-blue-50 dark:bg-blue-950/30 border-2 border-dashed border-blue-500 rounded-xl">
          ...
          {/* Client Steps */}
          <div className="space-y-3 relative">
            {/* Step 5: Client receives HTML */}
            <div
              className={`relative transition-all duration-500 ${
                currentStep >= 4 ? "opacity-100" : "opacity-30"
              }`}
            >
              <div className="border-2 border-dashed border-blue-500 rounded-xl p-3 bg-blue-50/50 dark:bg-blue-950/30 shadow-md min-h-[60px] flex items-center">
            ...
            >
              ...
              <div className="border-2 border-solid border-blue-500 rounded-xl p-3 bg-blue-50/50 dark:bg-blue-950/30 shadow-md min-h-[60px] flex items-center">
